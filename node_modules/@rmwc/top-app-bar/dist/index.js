...
var TopAppBarRoot = base_1.componentFactory({
...
exports.TopAppBarRow = base_1.componentFactory({
    displayName: 'TopAppBarRow',
    classNames: ['mdc-top-app-bar__row']
});
/** A section for the app bar. */
exports.TopAppBarSection = base_1.componentFactory({
...
exports.TopAppBarNavigationIcon = base_1.componentFactory({
...
exports.TopAppBarActionItem = base_1.componentFactory({
    displayName: 'TopAppBarActionItem',
    classNames: ['mdc-top-app-bar__action-item'],
    tag: icon_button_1.IconButton
});
/** A title for the top app bar. */
exports.TopAppBarTitle = base_1.componentFactory({
...
exports.TopAppBarFixedAdjust = base_1.componentFactory({
...
var TopAppBarBase = /** @class */ (function (_super) {
    ...
    TopAppBarBase.prototype.componentDidMount = function () {
        ...
        this.navIcon =
            this.root.ref &&
                this.root.ref.querySelector(top_app_bar_1.MDCTopAppBarFoundation.strings.NAVIGATION_ICON_SELECTOR);
        ...
        var adapter = {
            ...
            getTotalActionItems: function () {
                return _this.root.ref
                    ? _this.root.ref.querySelectorAll(top_app_bar_1.MDCTopAppBarFoundation.strings.ACTION_ITEM_SELECTOR).length
                    : 0;
            }
        };
        var foundation;
        if (this.props.short) {
            foundation = new top_app_bar_1.MDCShortTopAppBarFoundation(adapter);
        }
        else if (this.props.fixed) {
            foundation = new top_app_bar_1.MDCFixedTopAppBarFoundation(adapter);
        }
        else {
...
exports.TopAppBar = function (props) { return (React.createElement(TopAppBarBase, __assign({ key: props.short ? 'short' : props.fixed ? 'fixed' : 'top-app-bar' }, props))); };
...
var SimpleTopAppBar = /** @class */ (function (_super) {
    ...
    SimpleTopAppBar.prototype.render = function () {
        ...
        return (React.createElement(exports.TopAppBar, __assign({}, rest),
            React.createElement(exports.TopAppBarRow, null,
                React.createElement(exports.TopAppBarSection, { alignStart: true },
                    !!navigationIcon && (React.createElement(exports.TopAppBarNavigationIcon, __assign({ icon: "menu" }, (typeof navigationIcon === 'boolean' ? {} : navigationIcon)))),
                    !!title && React.createElement(exports.TopAppBarTitle, null, title),
                    startContent),
                (!!actionItems || endContent) && (React.createElement(exports.TopAppBarSection, { alignEnd: true },
                    endContent,
                    !!actionItems &&
                        actionItems.map(function (actionItemProps, index) { return (React.createElement(exports.TopAppBarActionItem, __assign({}, actionItemProps, { key: index }))); }))))));
    };

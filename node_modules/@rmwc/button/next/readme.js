...
export default function () {
    return (React.createElement(Docs, { title: "Buttons", lead: "Buttons communicate the action that will occur when the user touches them.", module: "@rmwc/button", styles: ['@material/button/dist/mdc.button.css'], docsLink: "https://material.io/develop/web/components/buttons/", examples: examples },
        ...
        React.createElement(DocsExample, { label: "Theming" },
            React.createElement(React.Fragment, null,
                ...
                React.createElement(Button, { label: "With Theme", theme: "secondary", ripple: { accent: true } }))),
        React.createElement(DocsExample, null,
            React.createElement(Button, null, "As Children")),
        React.createElement(DocProps, { src: propsSrc, components: [Button] })));
}

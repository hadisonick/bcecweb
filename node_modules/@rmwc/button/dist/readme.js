...
function default_1() {
    return (react_1.default.createElement(_doc_utils_1.Docs, { title: "Buttons", lead: "Buttons communicate the action that will occur when the user touches them.", module: "@rmwc/button", styles: ['@material/button/dist/mdc.button.css'], docsLink: "https://material.io/develop/web/components/buttons/", examples: generated_examples_json_1.default },
        ...
        react_1.default.createElement(_doc_utils_1.DocsExample, { label: "Theming" },
            react_1.default.createElement(react_1.default.Fragment, null,
                ...
                react_1.default.createElement(_1.Button, { label: "With Theme", theme: "secondary", ripple: { accent: true } }))),
        react_1.default.createElement(_doc_utils_1.DocsExample, null,
            react_1.default.createElement(_1.Button, null, "As Children")),
        react_1.default.createElement(_doc_utils_1.DocProps, { src: generated_props_json_1.default, components: [_1.Button] })));
}

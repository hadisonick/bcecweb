...
export default function () {
    return (React.createElement(Docs, { title: "Chips", lead: "Chips represent complex entities in small blocks, such as a contact.", module: "@rmwc/chip", styles: ['@material/chips/dist/mdc.chips.css'], docsLink: "https://material.io/develop/web/components/chips/", examples: examples },
        ...
        React.createElement(DocsExample, { label: "Filter" }, function Example() {
            ...
            return (React.createElement(ChipSet, { filter: true },
                React.createElement(Chip, { selected: selected.cookies, checkmark: true, onClick: function () { return toggleSelected('cookies'); }, label: "Cookies", trailingIcon: "close" }),
                React.createElement(Chip, { selected: selected.pizza, checkmark: true, onClick: function () { return toggleSelected('pizza'); }, icon: "local_pizza", label: "Pizza", trailingIcon: "close" }),
                React.createElement(Chip, { selected: selected.icecream, checkmark: true, onClick: function () { return toggleSelected('icecream'); }, icon: "favorite_border", trailingIcon: "close", label: "Icecream" })));
        }),
        React.createElement(DocsExample, { label: "Choice" }, function Example() {
            ...
            return (React.createElement(ChipSet, { choice: true },
                React.createElement(Chip, { selected: selected.cookies, onClick: function () { return toggleSelected('cookies'); }, label: "Cookies", trailingIcon: "close" }),
                React.createElement(Chip, { selected: selected.pizza, onClick: function () { return toggleSelected('pizza'); }, icon: "local_pizza", label: "Pizza", trailingIcon: "close" }),
                React.createElement(Chip, { selected: selected.icecream, onClick: function () { return toggleSelected('icecream'); }, icon: "favorite_border", trailingIcon: "close", label: "Icecream" })));
        }),
        React.createElement(DocProps, { src: propsSrc, components: [Chip, ChipSet] })));
}

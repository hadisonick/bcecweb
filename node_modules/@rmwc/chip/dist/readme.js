...
var _1 = require(".");
function default_1() {
    return (react_1.default.createElement(_doc_utils_1.Docs, { title: "Chips", lead: "Chips represent complex entities in small blocks, such as a contact.", module: "@rmwc/chip", styles: ['@material/chips/dist/mdc.chips.css'], docsLink: "https://material.io/develop/web/components/chips/", examples: generated_examples_json_1.default },
        ...
        react_1.default.createElement(_doc_utils_1.DocsExample, { label: "Event Handling" }, function Example() {
            var _a = __read(react_1.default.useState(false), 2), selected = _a[0], setSelected = _a[1];
        ...
        react_1.default.createElement(_doc_utils_1.DocsExample, { label: "Filter" }, function Example() {
            ...
            var toggleSelected = function (key) {
                var _a;
                return setSelected(__assign({}, selected, (_a = {}, _a[key] = !selected[key], _a)));
            };
            return (react_1.default.createElement(_1.ChipSet, { filter: true },
                react_1.default.createElement(_1.Chip, { selected: selected.cookies, checkmark: true, onClick: function () { return toggleSelected('cookies'); }, label: "Cookies", trailingIcon: "close" }),
                react_1.default.createElement(_1.Chip, { selected: selected.pizza, checkmark: true, onClick: function () { return toggleSelected('pizza'); }, icon: "local_pizza", label: "Pizza", trailingIcon: "close" }),
                react_1.default.createElement(_1.Chip, { selected: selected.icecream, checkmark: true, onClick: function () { return toggleSelected('icecream'); }, icon: "favorite_border", trailingIcon: "close", label: "Icecream" })));
        }),
        react_1.default.createElement(_doc_utils_1.DocsExample, { label: "Choice" }, function Example() {
            ...
            return (react_1.default.createElement(_1.ChipSet, { choice: true },
                react_1.default.createElement(_1.Chip, { selected: selected.cookies, onClick: function () { return toggleSelected('cookies'); }, label: "Cookies", trailingIcon: "close" }),
                react_1.default.createElement(_1.Chip, { selected: selected.pizza, onClick: function () { return toggleSelected('pizza'); }, icon: "local_pizza", label: "Pizza", trailingIcon: "close" }),
                react_1.default.createElement(_1.Chip, { selected: selected.icecream, onClick: function () { return toggleSelected('icecream'); }, icon: "favorite_border", trailingIcon: "close", label: "Icecream" })));
        }),
        react_1.default.createElement(_doc_utils_1.DocProps, { src: generated_props_json_1.default, components: [_1.Chip, _1.ChipSet] })));
}

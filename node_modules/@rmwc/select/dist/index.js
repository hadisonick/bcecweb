...
var SelectRoot = ripple_1.withRipple()(base_2.componentFactory({
...
var SelectEnhancedControl = /** @class */ (function (_super) {
    ...
    SelectEnhancedControl.prototype.render = function () {
        ...
        var showPlaceholder = (placeholder !== undefined ||
            ...
            currentIndex++ === 0;
        return (React.createElement(menu_1.Menu, __assign({}, rest, { ref: apiRef, className: "mdc-select__menu" }),
            showPlaceholder && (React.createElement(menu_1.MenuItem, { selected: currentIndex - 1 === selectedIndex, "data-value": "" }, placeholder)),
            selectOptions.map(function (_a, i) {
                var label = _a.label, options = _a.options, option = __rest(_a, ["label", "options"]);
                if (options) {
                    return (React.createElement(list_1.ListGroup, { key: label },
                        React.createElement(list_1.ListGroupSubheader, { theme: "textDisabledOnBackground" }, label),
                        React.createElement(menu_1.MenuItems, null, options.map(function (_a, i) {
                            var label = _a.label, option = __rest(_a, ["label"]);
                            currentIndex += 1;
                            return (React.createElement(menu_1.MenuItem, __assign({ key: label + "-" + option.value, activated: currentIndex - 1 === selectedIndex }, option, { "data-value": option.value }), label));
                        })),
                        i < selectOptions.length - 1 && React.createElement(list_1.ListDivider, null)));
                }
                currentIndex += 1;
                return (React.createElement(menu_1.MenuItem, __assign({ key: label + "-" + option.value, activated: currentIndex - 1 === selectedIndex }, option, { "data-value": option.value }), label));
            }),
...
var SelectBase = /** @class */ (function (_super) {
    ...
    function SelectBase(props) {
        ...
        _this.id = _this.props.id || base_2.randomId('select');
    ...
    SelectBase.prototype.getDefaultFoundation = function () {
        return new select_1.MDCSelectFoundation(__assign({}, (this.props.enhanced
    ...
    SelectBase.prototype.getNativeSelectAdapterMethods_ = function () {
        ...
        return {
            ...
            setValid: function (isValid) {
                isValid
                    ? _this.root.removeClass(select_1.MDCSelectFoundation.cssClasses.INVALID)
                    : _this.root.addClass(select_1.MDCSelectFoundation.cssClasses.INVALID);
            },
    ...
    SelectBase.prototype.getEnhancedSelectAdapterMethods_ = function () {
        ...
        return {
            getValue: function () {
                ...
                if (listItem &&
                    listItem.hasAttribute(select_1.MDCSelectFoundation.strings.ENHANCED_VALUE_ATTR)) {
                    value = listItem.getAttribute(select_1.MDCSelectFoundation.strings.ENHANCED_VALUE_ATTR);
                }
                return value === '' && _this.props.placeholder ? ' ' : value;
            },
            setValue: function (value) {
                if (_this.menuElement) {
                    var element = _this.menuElement.querySelector("[" + select_1.MDCSelectFoundation.strings.ENHANCED_VALUE_ATTR + "=\"" + value + "\"]");
            ...
            checkValidity: function () {
                ...
                if (classList &&
                    classList.contains(select_1.MDCSelectFoundation.cssClasses.REQUIRED) &&
                    !classList.contains(select_1.MDCSelectFoundation.cssClasses.DISABLED)) {
    ...
    SelectBase.prototype.renderHelpText = function () {
        ...
        return helpText && shouldSpread ? (React.createElement(exports.SelectHelperText, __assign({}, helpText))) : (React.createElement(exports.SelectHelperText, null, helpText));
    };
    SelectBase.prototype.render = function () {
        ...
        if (withLeadingIcon !== undefined) {
            base_1.deprecationWarning("Select prop 'withLeadingIcon' is now 'icon'.");
        ...
        var renderedLabel = (React.createElement(floating_label_1.FloatingLabel, __assign({}, this.label.props({}), { ref: this.label.setRef }), label));
        return (React.createElement(React.Fragment, null,
            React.createElement(SelectRoot, __assign({ ripple: !outlined }, this.root.props(__assign({ className: className }, rootProps)), { invalid: invalid, required: rest.required, icon: icon, outlined: outlined, ref: this.root.setRef }),
                ...
                !!outlined ? (React.createElement(notched_outline_1.NotchedOutline, __assign({}, this.outline.props({})), renderedLabel)) : (React.createElement(React.Fragment, null,
                    renderedLabel,
                    React.createElement(line_ripple_1.LineRipple, __assign({}, this.lineRipple.props({})))))),
            this.renderHelpText()));
    };
    return SelectBase;
}(base_2.FoundationComponent));
...
var SelectIcon = /** @class */ (function (_super) {
    ...
    SelectIcon.prototype.getDefaultFoundation = function () {
        var _this = this;
        return new select_1.MDCSelectIconFoundation({
    ...
    SelectIcon.prototype.render = function () {
        return (React.createElement(icon_1.Icon, __assign({}, this.root.props(__assign({}, this.props, { className: 'mdc-select__icon' })))));
    };
    SelectIcon.displayName = 'SelectIcon';
    return SelectIcon;
}(base_2.FoundationComponent));
exports.SelectIcon = SelectIcon;
exports.SelectHelperText = base_2.componentFactory({

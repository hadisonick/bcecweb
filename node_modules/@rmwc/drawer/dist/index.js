...
exports.DrawerAppContent = base_1.componentFactory({
    displayName: 'DrawerAppContent',
    classNames: ['mdc-drawer-app-content']
});
exports.DrawerRoot = base_1.componentFactory({
...
var slidableDrawerFactory = function (MDCConstructor, displayName) { var _a; return _a = /** @class */ (function (_super) {
        ...
        class_1.prototype.componentDidMount = function () {
            ...
            this.root.ref &&
                (this.focusTrap = base_2.createFocusTrap(this.root.ref, {
        ...
        class_1.prototype.render = function () {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(exports.DrawerRoot, __assign({ ref: this.root.setRef }, this.root.props(rest), { onKeyDown: this.handleKeyDown, onTransitionEnd: this.handleTransitionEnd })),
    ...
    _a; };
var ModalDrawer = slidableDrawerFactory(drawer_1.MDCModalDrawerFoundation, 'ModalDrawer');
var DismissibleDrawer = slidableDrawerFactory(drawer_1.MDCDismissibleDrawerFoundation, 'dismissibleDrawer');
/** A Drawer component. */
exports.Drawer = function (props) {
    ...
    return React.createElement(exports.DrawerRoot, __assign({}, props));
};

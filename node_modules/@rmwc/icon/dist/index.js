...
var renderUrl = function (_a) {
    var content = _a.content, rest = __rest(_a, ["content"]);
    return (React.createElement(IconRoot, __assign({}, rest, { className: base_1.classNames(rest.className, 'rmwc-icon--image'), style: __assign({}, rest.style, { backgroundImage: "url(" + content + ")" }) })));
};
...
var IconRoot = base_1.componentFactory({ displayName: 'IconRoot', tag: 'i' });
/** An Icon component. Most of these options can be set once globally, read the documentation on Provider for more info. */
exports.Icon = provider_1.withProviderContext()(function (_a) {
    var _b;
    ...
    if (!!deprecatedIconOption) {
        ...
        base_1.deprecationWarning("Icon component prop 'iconOptions' is deprecated. You options should now be passed directly to the 'icon' prop. I.E. icon={" + JSON.stringify(converted) + "}");
    }
    ...
    var rendered = renderToUse(__assign({}, rest, optionsRest, { content: contentToUse, className: base_1.classNames('rmwc-icon', basenameToUse, rest.className, optionsRest.className, iconClassName, (_b = {},

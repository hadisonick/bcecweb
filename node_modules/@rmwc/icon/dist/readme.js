...
function default_1() {
    return (react_1.default.createElement(_doc_utils_1.Docs, { title: "Icons", lead: "Material icons use geometric shapes to visually represent core ideas, capabilities, or topics.", module: "@rmwc/icon", styles: ['@rmwc/icon/icon.css'], docsLink: "https://material.io/icons", examples: generated_examples_json_1.default },
        ...
        react_1.default.createElement(_doc_utils_1.DocsP, null, "By default, the Icon component will attempt to detect the strategy for the icon you are embedding. For example, it assumes if pass something that starts with `http://` to the `icon` prop that you are attempting to load an image and will render it accordingly. Beacuse of ambiguity with ligatures verses icons added using classNames, you might have to explicitly set the strategy by passing it in as an option, or setting it as a global default using the `RMWCProvider`.`RMWCProvider` provides other global icon options. Please see the \"Provider\" section for more detail."),
        react_1.default.createElement(_doc_utils_1.DocsP, null, "The default strategy is 'ligature' which works with the material.io font icon set."),
        ...
        react_1.default.createElement(_doc_utils_1.DocProps, { src: generated_props_json_1.default, components: [_1.Icon] })));
}

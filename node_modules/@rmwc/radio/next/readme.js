    ...
    return (React.createElement(Docs, { title: "Radio Buttons", lead: "Radio buttons allow the user to select one option from a set. Use radio buttons for exclusive selection if you think that the user needs to see all available options side-by-side.", module: "@rmwc/radio", styles: [
        ...
        React.createElement(DocsExample, null, function Example() {
            ...
            return (React.createElement(React.Fragment, null,
                React.createElement(Radio, { value: "cookies", checked: value === 'cookies', onChange: function (evt) { return setValue(evt.currentTarget.value); } }, "Cookies"),
                React.createElement(Radio, { value: "pizza", checked: value === 'pizza', onChange: function (evt) { return setValue(evt.currentTarget.value); } }, "Pizza"),
                React.createElement(Radio, { value: "icecream", checked: value === 'icecream', onChange: function (evt) { return setValue(evt.currentTarget.value); } }, "Icecream")));
        }),
        ...
        React.createElement(DocProps, { src: propsSrc, components: [Radio] })));
}

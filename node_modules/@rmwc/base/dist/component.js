...
var handleClassNames = function (props, classNames, className, theme) {
    var finalClassNames = classnames_1.default.apply(void 0, __spread([className], (!!theme ? with_theme_1.parseThemeOptions(theme) : []), (typeof classNames === 'function' ? classNames(props) : classNames)));

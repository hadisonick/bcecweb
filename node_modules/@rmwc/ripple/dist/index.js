...
var Ripple = /** @class */ (function (_super) {
    ...
    Ripple.prototype.getDefaultFoundation = function () {
        ...
        return new ripple_1.MDCRippleFoundation({
            ...
            registerDocumentInteractionHandler: function (evtType, handler) {
                return document.documentElement.addEventListener(evtType, handler, base_1.applyPassive());
            },
            deregisterDocumentInteractionHandler: function (evtType, handler) {
                return document.documentElement.removeEventListener(evtType, handler, base_1.applyPassive());
            },
    ...
    Ripple.prototype.render = function () {
        ...
        var rippleSurfaceProps = surfaceIsRoot
            ...
            : {};
        var finalClassNames = base_1.classNames(className, rippleSurfaceProps.className, child.props.className, {

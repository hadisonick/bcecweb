...
var _1 = require(".");
function default_1() {
    return (react_1.default.createElement(_doc_utils_1.Docs, { title: "Icon Buttons", lead: "Icon buttons allow users to take actions, and make choices, with a single tap.", module: "@rmwc/icon-button", styles: ['@material/icon-button/dist/mdc.icon-button.css'], docsLink: "https://material.io/develop/web/components/buttons/icon-buttons/", examples: generated_examples_json_1.default },
        ...
        react_1.default.createElement(_doc_utils_1.DocsExample, { label: "Controlled" }, function Controlled() {
            var _a = __read(react_1.default.useState(false), 2), isChecked = _a[0], setIsChecked = _a[1];
        ...
        react_1.default.createElement(_doc_utils_1.DocProps, { src: generated_props_json_1.default, components: [_1.IconButton] })));
}

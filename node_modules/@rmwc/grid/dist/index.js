...
var GridRoot = base_1.componentFactory({
...
exports.Grid = function (_a) {
    ...
    return (React.createElement(GridRoot, __assign({}, rest), !!needsInnerGrid ? React.createElement(exports.GridInner, null, children) : children));
};
exports.Grid.displayName = 'Grid';
/** A Grid cell */
exports.GridCell = base_1.componentFactory({
...
exports.GridInner = base_1.componentFactory({

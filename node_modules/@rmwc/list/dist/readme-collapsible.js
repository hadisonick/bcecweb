...
var generated_examples_collapsible_json_1 = __importDefault(require("./generated-examples-collapsible.json"));
var _1 = require(".");
...
function default_1() {
    return (react_1.default.createElement(_doc_utils_1.Docs, { title: "Collapsible Lists", lead: "Lists are continuous, vertical indexes of text or images.", module: "@rmwc/list", styles: [
        ...
        react_1.default.createElement(_doc_utils_1.DocProps, { src: generated_props_json_1.default, components: [rmwc_1.CollapsibleList] })));
}

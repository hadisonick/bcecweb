...
var List = /** @class */ (function (_super) {
    ...
    Object.defineProperty(List.prototype, "listElements", {
        get: function () {
            if (this.root.ref) {
                return [].slice.call(this.root.ref.querySelectorAll("." + list_1.MDCListFoundation.cssClasses.LIST_ITEM_CLASS));
            }
            return [];
        },
        enumerable: true,
    ...
    List.prototype.getDefaultFoundation = function () {
        var _this = this;
        return new list_1.MDCListFoundation(
        /** @type {!MDCListAdapter} */ (Object.assign({
            ...
            setTabIndexForListItemChildren: function (listItemIndex, tabIndexValue) {
                ...
                var listItemChildren = [].slice.call(element.querySelectorAll(list_1.MDCListFoundation.strings.CHILD_ELEMENTS_TO_TOGGLE_TABINDEX));
            ...
            hasCheckboxAtIndex: function (index) {
                ...
                return !!listItem.querySelector(list_1.MDCListFoundation.strings.CHECKBOX_SELECTOR);
            },
            hasRadioAtIndex: function (index) {
                var listItem = _this.listElements[index];
                return !!listItem.querySelector(list_1.MDCListFoundation.strings.RADIO_SELECTOR);
            },
            isCheckboxCheckedAtIndex: function (index) {
                var listItem = _this.listElements[index];
                var toggleEl = listItem.querySelector(list_1.MDCListFoundation.strings.CHECKBOX_SELECTOR);
                return toggleEl ? toggleEl.checked : false;
            },
            setCheckedCheckboxOrRadioAtIndex: function (index, isChecked) {
                var listItem = _this.listElements[index];
                var toggleEl = listItem.querySelector(list_1.MDCListFoundation.strings.CHECKBOX_RADIO_SELECTOR);
                if (toggleEl) {
    ...
    List.prototype.getListItemIndex = function (evt) {
        ...
        while (eventTarget &&
            !eventTarget.classList.contains(list_1.MDCListFoundation.cssClasses.LIST_ITEM_CLASS) &&
            !eventTarget.classList.contains(list_1.MDCListFoundation.cssClasses.ROOT)) {
    ...
    List.prototype.handleClick = function (evt) {
        ...
        var toggleCheckbox = !base_1.matches(evt.target, list_1.MDCListFoundation.strings.CHECKBOX_RADIO_SELECTOR);
    ...
    List.prototype.handleKeydown = function (evt) {
        ...
        if (index >= 0) {
            this.foundation.handleKeydown(evt, evt.target instanceof Element &&
                evt.target.classList.contains(list_1.MDCListFoundation.cssClasses.LIST_ITEM_CLASS), index);
        }
    };

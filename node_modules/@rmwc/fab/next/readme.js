...
export default function () {
    return (React.createElement(Docs, { title: "Fabs", lead: "A floating action button (FAB) represents the primary action of a screen.", module: "@rmwc/fab", styles: ['@material/fab/dist/mdc.fab.css'], docsLink: "https://material.io/develop/web/components/buttons/floating-action-buttons/", examples: examples },
        ...
        React.createElement(DocProps, { src: propsSrc, components: [Fab] })));
}

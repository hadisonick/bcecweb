 ...
 * @category Elasticsearch
 */
export interface ElasticsearchQueryBuilderArgsPlugin<T extends ContextInterface = ContextInterface> {
    /**
 ...
 */
export interface ElasticsearchQueryModifierPluginParams<T extends ContextInterface = ContextInterface> {
    /**
     * Context we are working in.
     */
    context: T;

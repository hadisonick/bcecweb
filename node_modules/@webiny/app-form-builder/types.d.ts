...
import { BindComponent, FormRenderPropParams, Form, FormRenderPropParamsSubmit } from "@webiny/form";
...
export declare type FbBuilderFormFieldPatternValidatorPlugin = Plugin & {
...
export declare type FbRevisionModel = {
    id: string;
    name: string;
    version: number;
    published: boolean;

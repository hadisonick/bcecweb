...
var Upgrade = function Upgrade(_ref) {
        ...
        switch (_context.prev = _context.next) {
          case 0:
            ...
            return client.mutate({
              ...
              var data = _ref3.data;
              setLoading(false);
              var error = data.formBuilder.upgrade.error;
  ...
  var label = error ? /*#__PURE__*/React.createElement(Alert, {
    ...
    type: "danger"
  }, error) : t(_templateObject3 || (_templateObject3 = _taggedTemplateLiteral(["Upgrading Form Builder..."])));

...
var FBInstaller = function FBInstaller(_ref) {
  ...
  useEffect(function () {
    ...
    setTimeout(function () {
      client.mutate({
        ...
        var data = _ref2.data;
        var error = data.formBuilder.install.error;
  ...
  var label = error ? /*#__PURE__*/React.createElement(Alert, {
    ...
    type: "danger"
  }, error) : t(_templateObject4 || (_templateObject4 = _taggedTemplateLiteral(["Installing Form Builder..."])));
...
var plugin = {
  ...
  title: t(_templateObject5 || (_templateObject5 = _taggedTemplateLiteral(["Form Builder"]))),
        ...
        while (1) {
          switch (_context.prev = _context.next) {
            ...
            case 3:
              ...
              return _context.abrupt("return", data.formBuilder.version);

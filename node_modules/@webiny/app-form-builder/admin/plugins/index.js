...
export default (function () {
  return [permissionRenderer(), install, settings, routes, menus, formDetailsPreviewContent, formDetailsRevisions, formDetailsSubmissions, formEditorDefaultBar, formEditorSettings];
});

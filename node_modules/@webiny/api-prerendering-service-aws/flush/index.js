  ...
  return {
    ...
    afterFlush: async ({
      ...
      const {
        args,
        configuration
      } = render; // Let's create a cache invalidation request.
      ...
      path += "*";
      log(`Proceeding with issuing a cache invalidation request to CloudFront distribution "${distributionId}", path "${path}".`);

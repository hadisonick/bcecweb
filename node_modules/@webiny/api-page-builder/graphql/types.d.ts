...
export declare type ListPagesParams = {
    limit?: number;
    page?: number;
    where?: {
        category?: string;
...
export declare type FlushParams = {
    tags?: TagItem[];
    paths?: PathItem[];
};
export declare type PagesCrud = {
    dataLoaders: {
        getPublishedById: DataLoader<{
            id: string;
            preview?: boolean;
        }, Page>;
    };
    ...
    getPublishedByPath<TPage extends Page = Page>(args: {
        path: string;
    }): Promise<TPage>;
...
export declare type PageElementsCrud = {
...
export declare type CategoriesCrud = {
    dataLoaders: {
...
declare type DefaultSettingsCrudOptions = {
    tenant?: string | false;
    locale?: string | false;
};
export declare type SettingsCrud = {
    ...
    default: {
        ...
        update: (data: Record<string, any>, options?: {
            auth?: boolean;
        } & DefaultSettingsCrudOptions) => Promise<DefaultSettings>;
...
export declare type PbContext = Context<I18NContentContext, I18NContext, ClientContext, DbContext, ElasticsearchContext, SecurityContext, TenancyContext, PrerenderingServiceClientContext, {

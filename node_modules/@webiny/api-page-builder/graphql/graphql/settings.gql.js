    ...
    resolvers: {
      ...
      PbQuery: {
        getCurrentSettings: async (_, args, context) => {
          try {
            return new _responses.Response(await context.pageBuilder.settings.default.getCurrent());
          } catch (err) {
        ...
        getSettings: async (_, args, context) => {
          try {
            return new _responses.Response(await context.pageBuilder.settings.default.get());
          } catch (err) {
            return new _responses.ErrorResponse(err);
          }
        },
        getDefaultSettings: async (_, args, context) => {
          try {
            return new _responses.Response(await context.pageBuilder.settings.default.getDefault());
          } catch (err) {
            return new _responses.ErrorResponse(err);
          }
        }
      ...
      PbMutation: {
        updateSettings: async (_, args, context) => {
          try {
            return new _responses.Response(await context.pageBuilder.settings.default.update(args.data));
          } catch (err) {
            return new _responses.ErrorResponse(err);
          }
        }
...
//# sourceMappingURL=settings.gql.js.map
...
var _pageSettings = _interopRequireDefault(require("./pages/pageSettings"));

var _oEmbed = require("./pages/oEmbed");
    ...
    resolvers: {
      ...
      PbQuery: {
        getPage: async (_, args, context) => {
          try {
            return new _responses.Response(await context.pageBuilder.pages.get(args.id));
          } catch (e) {
        ...
        listPageTags: async (_, args, context) => {
          return (0, _resolve.default)(() => context.pageBuilder.pages.listTags(args));
        },
        getPublishedPage: async (_, args, context) => {
          if (args.id) {
            return (0, _resolve.default)(() => context.pageBuilder.pages.getPublishedById({
              id: args.id,
              preview: args.preview
            }));
          }

          return (0, _resolve.default)(() => context.pageBuilder.pages.getPublishedByPath({
            path: args.path
          }));
        },
        oembedData: async (_, args) => {
          try {
            const provider = (0, _oEmbed.findProvider)(args.url);
            ...
            return new _responses.Response(await (0, _oEmbed.fetchEmbed)(args, provider));
          } catch (e) {
            return new _responses.ErrorResponse({
              code: "OEMBED_ERROR",
              message: e.message
      ...
      PbMutation: {
        createPage: async (_, args, context) => {
          return (0, _resolve.default)(() => {
            ...
            if (!from && !category) {
              throw new _error.default(`Cannot create page - you must provide either "from" or "category" input.`);
            }
        ...
        deletePage: async (_, args, context) => {
          return (0, _resolve.default)(async () => {
        ...
        updatePage: async (_, args, context) => {
          return (0, _resolve.default)(() => {
            const {
              data
            } = args;
        ...
        publishPage: async (_, args, context) => {
          return (0, _resolve.default)(() => context.pageBuilder.pages.publish(args.id));
        },
        unpublishPage: async (_, args, context) => {
          return (0, _resolve.default)(() => context.pageBuilder.pages.unpublish(args.id));
        },
        requestReview: async (_, args, context) => {
          return (0, _resolve.default)(() => context.pageBuilder.pages.requestReview(args.id));
        },
        requestChanges: async (_, args, context) => {
          return (0, _resolve.default)(() => context.pageBuilder.pages.requestChanges(args.id));
        }
      },
      PbPageSettings: {
        _empty: () => ""
...
var _default = [plugin, _pageSettings.default];

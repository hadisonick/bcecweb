 ...
 * @category Template
 */
export declare type CliCommandScaffoldQuestionsCallable = (args: CliCommandScaffoldQuestionsCallableArgs) => QuestionCollection;
/**
 ...
 * @category Template
 */
export interface CliCommandScaffoldCallableWithErrorArgs<T extends Record<string, any>> extends CliCommandScaffoldCallableArgs<T> {
    error: Error;
}
/**
 ...
 * @category Template
 */
export interface CliCommandScaffoldTemplate<T extends Record<string, any> = Record<string, any>> extends Plugin {
    /**
